...
angular.module('westernWildfire', ["ngRoute", "ui.bootstrap"]);

angular.module('westernWildfire').config(function($routeProvider) {
    $routeProvider
        .when('/', {
...
angular.module('westernWildfire').controller('aboutController', ['$scope', function($scope) {
}]);

angular.module('westernWildfire').controller('mainController', ['$scope', 'LoadService', function($scope, LoadService) {
    LoadService.data_load(
        $scope,
        'js/us-canada-small.json',
        'data/fires.csv',
        false
    );
}]);

angular.module('westernWildfire').controller('arizonaController', ['$scope', 'LoadService', function($scope, LoadService) {
    LoadService.data_load(
        $scope,
...
angular.module('westernWildfire').controller('californiaController', ['$scope', 'LoadService', function($scope, LoadService) {
    LoadService.data_load(
        $scope,
...
angular.module('westernWildfire').controller('coloradoController', ['$scope', 'LoadService', function($scope, LoadService) {
    LoadService.data_load(
        $scope,
...
angular.module('westernWildfire').controller('idahoController', ['$scope','LoadService', function($scope, LoadService) {
    LoadService.data_load(
        $scope,
...
angular.module('westernWildfire').controller('nevadaController', ['$scope', 'LoadService', function($scope, LoadService) {
    LoadService.data_load(
        $scope,
...
angular.module('westernWildfire').controller('newmexicoController', ['$scope', 'LoadService', function($scope, LoadService) {
    LoadService.data_load(
        $scope,
...
angular.module('westernWildfire').controller('oregonController', ['$scope', 'LoadService', function($scope, LoadService) {
    LoadService.data_load(
        $scope,
...
angular.module('westernWildfire').controller('texasController', ['$scope', 'LoadService', function($scope, LoadService) {
    LoadService.data_load(
        $scope,
...
angular.module('westernWildfire').controller('utahController', ['$scope', 'LoadService', function($scope, LoadService) {
    LoadService.data_load(
        $scope,
...
angular.module('westernWildfire').controller('washingtonController', ['$scope', 'LoadService', function($scope, LoadService) {
    LoadService.data_load(
        $scope,
...
angular.module('westernWildfire').controller('wyomingController', ['$scope', 'LoadService', function($scope, LoadService) {
    LoadService.data_load(
        $scope,
